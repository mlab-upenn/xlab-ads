...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
            ...
            break;
//        case 3:
//            navigationController.viewControllers = @[[self.storyboard instantiateViewControllerWithIdentifier:@"forthController"]];
//            [self.sideMenuViewController hideMenuViewController];
//            break;
        default:
            break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *titles = @[@"Home", @"Login", @"Register"];
    NSArray *images = @[@"IconHome", @"IconCalendar", @"IconProfile"];
    
//    NSArray *titles = @[@"Home", @"Login", @"Register", @"Settings", @"Log Out"];
