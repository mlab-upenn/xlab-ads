...
Also there's a definition of the protocol:
...
iOS part
The screen consist of 5 view controllers, which are menu view controller, first view controller, second view controller, third view controller. 
